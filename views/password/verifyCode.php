                ...
                <div class="authentication-inner py-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- /Logo -->
                            <h4 class="mb-2">Code de vérification 🔐</h4>
                            <p class="mb-4">Entrez le code reçu par email pour continuer la réinitialisation de votre mot de passe</p>
                            ...
                            <div class="text-center mt-2">
                                <a href="../password/PasswordForgotten.php" class="d-flex align-items-center justify-content-center">
                                    <i class="bx bx-chevron-left scaleX-n1-rtl bx-sm"></i>
                                    Revenir à l'envoi de code
                                </a>
                            </div>
                        </div>
                    </div>
